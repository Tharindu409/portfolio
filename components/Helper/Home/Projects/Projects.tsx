...
export default function Projects() {
  ...
  return (
    ...
    <div className="pt-16 pb-20">
      ...
      {/* Cards Grid */}
      <div className="w-[85%] mx-auto grid grid-cols-1 sm:grid-cols-2 
      lg:grid-cols-3 gap-8 mt-14"
          data-aos="fade-up" 
            ...
            >
              ...
              <div className="flex gap-4 mt-6">
                ...
                {/*<a
                  href={modal.live}
                  target="_blank"
                  className="px-4 py-2 bg-cyan-300 text-black rounded-lg hover:bg-cyan-400 transition"
                >
                  🚀 Live Demo
                </a>
                */}
